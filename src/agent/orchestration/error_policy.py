...
for _code in (
    'FRAGMENTS_INTAKE_MISMATCH', 'FRAGMENTS_CONTEXT_MISMATCH', 'FRAGMENTS_REFERENCE_MISMATCH',
    'FRAGMENTS_GROUP_MISMATCH', 'FRAGMENTS_SPECIES_MISMATCH', 'FRAGMENTS_WHITELIST_MISMATCH',
    'FRAGMENTS_BARCODE_LENGTH_UNSUPPORTED', 'FRAGMENTS_BARCODE_POLICY_UNRESOLVED',
    'FRAGMENTS_ROLE_MISSING', 'FRAGMENTS_LAYOUT_UNSUPPORTED', 'FRAGMENTS_INPUT_BINDING_UNREPRESENTABLE',
    'FRAGMENTS_FASTQ_MALFORMED', 'FRAGMENTS_RECORD_COUNT_MISMATCH', 'FRAGMENTS_READ_NAME_MISMATCH',
    'FRAGMENTS_SOURCE_CHANGED_BEFORE_EXECUTION', 'FRAGMENTS_SOURCE_CHANGED_DURING_EXECUTION',
    'FRAGMENTS_EMPTY', 'FRAGMENTS_OUTPUT_MALFORMED', 'FRAGMENTS_COORDINATES_INVALID',
    'FRAGMENTS_SUPPORT_INVALID', 'FRAGMENTS_CANONICALIZATION_FAILED', 'FRAGMENTS_INDEX_MISMATCH',
    'FRAGMENTS_ARTIFACT_CONFLICT', 'FRAGMENTS_VERIFICATION_MISMATCH', 'FRAGMENTS_INDEX_POLICY_UNSUPPORTED',
    'FRAGMENTS_RECOVERY_MISMATCH', 'FRAGMENTS_RECOVERY_UNAVAILABLE',
    'CHROMAP_EXECUTION_FAILED', 'CHROMAP_OUTPUT_INCOMPLETE',
    'CHROMAP_SOURCE_CHANGED', 'CHROMAP_REFERENCE_CHANGED', 'CHROMAP_WHITELIST_MISMATCH',
    'CHROMAP_FASTA_FAI_MISMATCH', 'CHROMAP_INDEX_BINDING_MISMATCH', 'CHROMAP_INDEX_IDENTITY_MISMATCH',
    'CHROMAP_INPUT_INVALID', 'CHROMAP_SOURCE_INVALID', 'CHROMAP_WHITELIST_REQUIRED',
    'CHROMAP_BARCODE_LENGTH_UNSUPPORTED', 'CHROMAP_GROUP_INVALID', 'CHROMAP_LAYOUT_UNSUPPORTED',
    'CHROMAP_ROLE_INVALID', 'CHROMAP_OUTPUT_CONFLICT', 'CHROMAP_INDEX_OUTPUT_CONFLICT',
):
    _ERROR_POLICY_CATALOG[_code] = ErrorPolicyEntry(
        'Canonical fragment preparation or verification failed; automatic execution retry is disabled.', _NO)
for _code in ('CHROMAP_UNAVAILABLE', 'CHROMAP_VERSION_UNSUPPORTED', 'CHROMAP_INDEX_INVALID',
    'CHROMAP_INDEX_UNAVAILABLE', 'CHROMAP_INDEX_AMBIGUOUS', 'CHROMAP_EXECUTABLE_MISMATCH',
    'CHROMAP_EXECUTABLE_UNQUALIFIED', 'CHROMAP_RUNTIME_MISMATCH', 'CHROMAP_IDENTITY_INVALID',
    'CHROMAP_INDEX_CONTRACT_INVALID', 'FRAGMENTS_TOOLCHAIN_MISMATCH'):
    _ERROR_POLICY_CATALOG[_code] = ErrorPolicyEntry(

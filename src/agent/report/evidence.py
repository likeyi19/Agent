...
_TOOL_PROJECTIONS: Mapping[str, _ToolProjection] = {
    "build_scATAC_cell_by_ccre": _ToolProjection(
        ...
        (_ArtifactProjection("manifest_path", "scatac_cell_by_ccre_manifest_json",
            # Scientific bases describe the independent proof, whether freshly
            # reconstructed or reused through validated accepted authority.
            ("independent_matrix_reconstruction", "strict_manifest_loading",
         ...
         _ArtifactProjection("matrix_path", "scatac_cell_by_ccre_h5ad",
            ("independent_matrix_reconstruction", "full_artifact_sha256", "exact_sparse_logical_identity"),
    ...
    "select_scATAC_cells": _ToolProjection(
        ...
        (_ArtifactProjection("manifest_path", "scatac_cell_selection_manifest_json",
            ("independent_cell_selection_reconstruction", "strict_manifest_loading",
    ...
    "compute_scATAC_qc": _ToolProjection(
        ...
        (_ArtifactProjection("manifest_path", "scatac_barcode_qc_manifest_json",
            ("independent_barcode_qc_reconstruction", "strict_manifest_loading",
             "authoritative_manifest_sha256", "exact_execution_receipt"),
            digest_field="manifest_sha256"),),
    ),
    "prepare_scATAC_bam_fragments": _ToolProjection(
        ...
        (_ArtifactProjection("manifest_path", "scatac_fragments_manifest_json",
            ("independent_bam_transformation_verification", "strict_manifest_loading",
    ...
    "import_scATAC_fragments": _ToolProjection(
        ...
        (_ArtifactProjection("manifest_path", "scatac_fragments_manifest_json",
            ("independent_external_adoption_verification", "strict_manifest_loading",
    ...
    "prepare_scATAC_fragments": _ToolProjection(
        ...
        (_ArtifactProjection("manifest_path", "scatac_fragments_manifest_json",
            ("independent_fragments_verification", "strict_manifest_loading",
    ...
    for step in ordered:
        ...
        if step.tool_name == "select_scATAC_cells":
            try:
                ...
                raise AnalysisEvidenceError("EVIDENCE_SOURCE_RESULT_INVALID",
                    "Freshly verified cell selection could not be projected.") from exc

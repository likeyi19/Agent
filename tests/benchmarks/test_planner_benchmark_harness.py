...
def test_corpus_covers_required_categories_workflows_and_tools(
    ...
    assert expected_tools | {"inspect_raw_scATAC", "prepare_scATAC_fragments", "import_scATAC_fragments", "prepare_scATAC_bam_fragments", "compute_scATAC_qc", "select_scATAC_cells", "build_scATAC_cell_by_ccre", "adopt_scATAC_cell_by_ccre", "annotate_scATAC_cell_types", "adopt_scATAC_cell_by_features", "adapt_epizoo_species", "build_scATAC_cell_by_features"} == set(build_default_tool_registry().names())
